...
try:
    for row in sheet.iter_rows(values_only=True):
        if row[0]==None:
            ...
            source="https://uniqusai-gpt-prod.s3.ap-south-1.amazonaws.com/big4/deloitte/deloitte3/"+row[0].strip()
            priority=2
            ...
            title=row[0].strip()
            status="active"
            link="https://uniqusai-gpt-prod.s3.ap-south-1.amazonaws.com/big4/deloitte/deloitte3/"+row[0].strip()
            fileMeta={
                "name":row[0],
